...
var_list="GGL_KEY1 GGL_KEY2 BASE_SCHEME BASE_HOST MYSQL_ADDON_HOST MYSQL_ADDON_PORT MYSQL_ADDON_DB MYSQL_ADDON_USER MYSQL_ADDON_PASSWORD MONGODB_ADDON_DB MONGODB_ADDON_URI"
