...
class LoadPageData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $page3->translate('de')->setDescription('en cours');
        ...
        $page4->translate('de')->setMetaTitle('Mentions légales');

        $page4->translate('en')->setTitle('Legal notices');
        $page4->translate('fr')->setTitle('Mentions légales');
        $page4->translate('de')->setTitle('Mentions légales');
        ...
        $page4->translate('de')->setDescription('en cours');
