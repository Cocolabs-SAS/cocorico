...
10. Check phone user from SMS (Optional. SMSBundle must be enabled)
...
13. Generate Bookings deposit refund (Optional. ListingDepositBundle must be enabled)
...
Rules:
    ...
    - min_start_time_delay must be >= cocorico.booking.acceptation_delay + 1 hour
